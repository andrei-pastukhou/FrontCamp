...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["e"] = fetchAllNewsFromServer;
/* harmony export (immutable) */ __webpack_exports__["d"] = clickLink;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = FETCH_NEWS;

const FETCH_NEWS_SUCCESS = 'FETCH_NEWS_SUCCESS';
/* harmony export (immutable) */ __webpack_exports__["c"] = FETCH_NEWS_SUCCESS;

const FETCH_NEWS_ERROR = 'FETCH_NEWS_ERROR';
/* unused harmony export FETCH_NEWS_ERROR */


const CLICK_LINK = 'CLICK_LINK';
/* harmony export (immutable) */ __webpack_exports__["a"] = CLICK_LINK;


//Function to get news from remote server. Function call in link onClick event
function fetchAllNewsFromServer() {
  return (dispatch, getState) => {
    ...
    if (source) {
      ...
      const req = new Request(`${__WEBPACK_IMPORTED_MODULE_0__config_js__["a" /* config */].url}?sources=${source}&sortBy=publishedAt&apiKey=${__WEBPACK_IMPORTED_MODULE_0__config_js__["a" /* config */].apiKey}`);
      fetch(req).then(response => {
        return response.json();
      }).then(data => dispatch({ type: FETCH_NEWS_SUCCESS, news: data.articles })).catch(errors => dispatch({ type: FETCH_NEWS_ERROR, errors: errors }));
    } else {
...
function clickLink(id, selected) {
  return {
    type: CLICK_LINK,
    id,
    selected
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_bootstrap_min_css__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__reducers__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__actions__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__renders_NewsList__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__renders_ChannelLink__ = __webpack_require__(31);
...
let store = Object(__WEBPACK_IMPORTED_MODULE_1_redux__["c" /* createStore */])(__WEBPACK_IMPORTED_MODULE_3__reducers__["a" /* default */], Object(__WEBPACK_IMPORTED_MODULE_1_redux__["a" /* applyMiddleware */])(__WEBPACK_IMPORTED_MODULE_2_redux_thunk___default.a));

//Function will call every time when store change. Use for visualization store state.
function render() {

  __WEBPACK_IMPORTED_MODULE_6__renders_ChannelLink__["a" /* render */](store);

  __WEBPACK_IMPORTED_MODULE_5__renders_NewsList__["a" /* render */](store);
}
...
store.dispatch(__WEBPACK_IMPORTED_MODULE_4__actions__["e" /* fetchAllNewsFromServer */]());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__channels__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__news__ = __webpack_require__(29);
...
const rootReducer = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["b" /* combineReducers */])({
  channels: __WEBPACK_IMPORTED_MODULE_1__channels__["a" /* default */], news: __WEBPACK_IMPORTED_MODULE_2__news__["a" /* default */]
});
...
/* harmony default export */ __webpack_exports__["a"] = ((state = initialState, action) => {
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__actions__["a" /* CLICK_LINK */]:
      let newState = state;
...
/* harmony default export */ __webpack_exports__["a"] = ((state = initialState, action) => {
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__actions__["b" /* FETCH_NEWS */]:
      return initialState;
    case __WEBPACK_IMPORTED_MODULE_0__actions__["c" /* FETCH_NEWS_SUCCESS */]:
      return action.news;
    default:
      return state;
  }
...
function render(store) {
  ...
  document.getElementById(__WEBPACK_IMPORTED_MODULE_0__config__["a" /* config */].domId.newsList).innerHTML = "";
  newsList.forEach(news => {
    ...
    document.getElementById(__WEBPACK_IMPORTED_MODULE_0__config__["a" /* config */].domId.newsList).appendChild(domElement);
  });
}
...
function render(store) {
  ...
  document.getElementById(__WEBPACK_IMPORTED_MODULE_0__config__["a" /* config */].domId.channelList).innerHTML = "";
  channels.forEach((channel, index) => {
    let onClickFunction = e => {
      e.preventDefault();
      store.dispatch(__WEBPACK_IMPORTED_MODULE_1__actions__["d" /* clickLink */](index, !channel.selected));
      store.dispatch(__WEBPACK_IMPORTED_MODULE_1__actions__["e" /* fetchAllNewsFromServer */]());
    };
    ...
    document.getElementById(__WEBPACK_IMPORTED_MODULE_0__config__["a" /* config */].domId.channelList).appendChild(domElement);
  });
}
